...
#let primary_color = rgb("#1a73e8")
#let primary_dark = rgb("#0d47a1")
...
#let box_objetivo(cuerpo) = block(
  ...
  radius: 3.0pt,
  stroke: (left: 2.5pt + primary_color),
  width: 100%,
  breakable: true,
  [
    #text(weight: "bold", fill: primary_dark, size: 8.2pt)[🎯 Objetivo de Aprendizaje] \
    #v(0.3pt)
    #cuerpo
  ]
)

#let box_sabias(cuerpo) = block(
  fill: rgb("#fef7e0"),
  inset: (x: 5.5pt, y: 4.0pt),
  radius: 3.0pt,
  stroke: (left: 2.5pt + accent_color),
  width: 100%,
  breakable: true,
  [
...
#let actividad_card(titulo, cuerpo) = block(
  fill: rgb("#ffffff"),
  inset: (x: 5.5pt, y: 4.0pt),
  radius: 3.0pt,
  ...
  breakable: true,
  [
    #text(weight: "bold", fill: primary_color, size: 8.2pt)[#titulo] \
    #v(0.3pt)
    #cuerpo
  ]
)
...
#let box_evaluacion(titulo, url_str, qr_file, cuerpo) = block(
  ...
  [
    #grid(
      ...
      gutter: 6.0pt,
      [
        #text(weight: "bold", fill: eval_color, size: 8.2pt)[📝 #titulo] \
        #v(1.0pt)
        #text(size: 6.6pt)[Responde en el cuaderno o accede digitalmente con el botón/QR:] \
        #v(2.5pt)
        #link(url_str)[
          #box(fill: eval_color, radius: 2.0pt, inset: (x: 6.0pt, y: 3.0pt))[
...
#align(center)[#text(size: 9.8pt, weight: "bold", fill: primary_dark)[GUÍA: 4. LA SEGUNDA GUERRA MUNDIAL: EL SUICIDIO DE LA RAZÓN]]
#v(0.3pt)
...
#columns(2, gutter: 7.0pt)[
  ...
  #actividad_card("1. El Mundo en Llamas: El Estallido de la Guerra Total")[
...
Imagina que tu ciudad, tu país y el planeta entero se convierten en un inmenso campo de batalla. Así fue la Segunda Guerra Mundial (1939-1945), un conflicto que arrastró a la humanidad a su hora más oscura. No fue un simple choque de ejércitos en el frente; fue una 'guerra total' que borró la línea entre civiles y militares. Las potencias del Eje (Alemania, Italia y Japón) se enfrentaron a los Aliados (Gran Bretaña, Estados Unidos y la Unión Soviética) en una contienda que dejó ciudades hechas cenizas, millones de refugiados y que inauguró el terror de la era atómica.
  ...
  #actividad_card("2. El Estallido de la Guerra Total")[
    Copia en tu cuaderno este texto introductorio:
...
Imagina que tu ciudad, tu país y el planeta entero se convierten en un inmenso campo de batalla. Así fue la Segunda Guerra Mundial (1939-1945), un conflicto que arrastró a la humanidad a su hora más oscura. No fue un simple choque de ejércitos en el frente; fue una 'guerra total' que borró la línea entre civiles y militares. Las potencias del Eje (Alemania, Italia y Japón) se enfrentaron a los Aliados (Gran Bretaña, Estados Unidos y la Unión Soviética) en una contienda que dejó ciudades hechas cenizas, millones de refugiados y que inauguró el terror de la era atómica.
  ...
  #actividad_card("3. El Estallido de la Guerra Total (prueba)")[
    Copia en tu cuaderno este texto introductorio:
...
Imagina que tu ciudad, tu país y el planeta entero se convierten en un inmenso campo de batalla. Así fue la Segunda Guerra Mundial (1939-1945), un conflicto que arrastró a la humanidad a su hora más oscura. No fue un simple choque de ejércitos en el frente; fue una 'guerra total' que borró la línea entre civiles y militares. Las potencias del Eje (Alemania, Italia y Japón) se enfrentaron a los Aliados (Gran Bretaña, Estados Unidos y la Unión Soviética) en una contienda que dejó ciudades hechas cenizas, millones de refugiados y que inauguró el terror de la era atómica.
  ...
  #actividad_card("4. El Engaño Perfecto: El Síndrome K y la Resistencia Médica")[
